...
class Wechat
{
	...
	public function __construct($options)
	{
        ...
        $this->systemType = isset($options['systemType'])?$options['systemType']:'';
...
<Nonce><![CDATA[%s]]></Nonce>
	...
	protected function setCache($cachename,$value,$expired){
        ...
        error_log($this->systemType.$cachename);
        error_log($value);
        return MyCache::set($this->systemType.$cachename,$value,$expired);
		// return false;
	}
	...
	protected function getCache($cachename){
        ...
        error_log('access cache name is ' . $this->systemType.$cachename);
        return MyCache::get($this->systemType.$cachename);
		// return false;
	}
	...
	protected function removeCache($cachename){
        ...
        return MyCache::rm($this->systemType.$cachename);
		// return false;
	}
	...
	public function checkAuth($appid='',$appsecret='',$token=''){
		...
		if ($result)
		{
            ...
            error_log('new access_token is '.$this->access_token);
