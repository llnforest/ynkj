...
class Jssdk {
  ...
  public static function getSignPackage() {
    self::$appSecret = WeixinMember::$appsecret;
    self::$appId = WeixinMember::$appid;
  ...
  private static function getJsApiTicket() {
    ...
    $data = MyCache::get(MyCache::$M_WEIXIN_TICKET);
    if(empty($data)){
    ...
    if ($data['expire_time'] < time() || $data['jsapi_ticket'] == '') {
      ...
      if ($ticket) {
        ...
        MyCache::set(MyCache::$M_WEIXIN_TICKET,$data);
      }
    } else {
  ...
  private static function getAccessToken() {
    ...
    $data = MyCache::get(MyCache::$M_WEIXIN_ACCESS);
    if(empty($data)){
    ...
    if ($data['expire_time'] < time() || $data['access_token'] == '') {
      ...
      if ($access_token) {
        ...
        MyCache::set(MyCache::$M_WEIXIN_ACCESS,$data);
      }
    } else {
