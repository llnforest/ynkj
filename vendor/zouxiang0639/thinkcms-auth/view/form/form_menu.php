...
<div class="col-sm-12">
    <table class="table table-bordered">
        ...
        <tr>
            <th>状态</th>
            <td class="layui-form">
                <input type="checkbox" data-name="status" lay-skin="switch" lay-text="显示|隐藏" <?php if(isset($status) && $status == 1){echo 'checked';}?> data-value="1|0">
            </td>
        </tr>
        <tr>
            <th>类型</th>
            <td class="layui-form">
                <input type="radio" name="type" <?php echo empty($type)|$type==1?'checked':''?> value="1" title=" 权限认证+菜单">
