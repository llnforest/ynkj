...
-- Records of tp_admin
-- ----------------------------
INSERT INTO `tp_admin` VALUES ('1', 'admin', 'e10adc3949ba59abbe56e057f20f883e', '超管', '1', '', '', '0.0.0.0', '2018-03-23 09:45:49', '2017-10-18 00:07:01', '1', '1', null);
...
) ENGINE=MyISAM AUTO_INCREMENT=158 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='行为日志表';
...
INSERT INTO `tp_auth_menu` VALUES ('31', '21', 'user', 'favourite', 'index', '', '1', '1', '用户收藏', '', '', '0', '', '0', '', '');
...
INSERT INTO `tp_auth_rule` VALUES ('31', 'user', 'admin_url', 'user/favourite/index', '', '用户收藏', '1', '', '0');
...
CREATE TABLE `tp_base_banner` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='banner 表';

-- ----------------------------
-- Records of tp_base_banner
-- ----------------------------
INSERT INTO `tp_base_banner` VALUES ('2', '', '1', '\\images\\banner\\20180323\\6d1a5e6db8214f38be09ab963f6c7667.png', '', '1', '1');
...
CREATE TABLE `tp_base_notice` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻通知表';
...
CREATE TABLE `tp_base_search` (
  ...
  `sort` int(11) DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='筛选基础表';
...
CREATE TABLE `tp_house` (
  ...
  `mianji` int(11) DEFAULT NULL COMMENT '建筑面积',
  ...
  `youtu` varchar(50) DEFAULT NULL COMMENT '用途',
  ...
  `admin_id` int(11) DEFAULT NULL COMMENT '经纪人id',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='房源信息表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='房源图集表';
...
CREATE TABLE `tp_user_record` (
  ...
  KEY `house_id` (`house_id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='看房记录表';
...
CREATE TABLE `tp_user_request` (
  ...
  `status` tinyint(1) DEFAULT '0' COMMENT '审核状态: 0待审核 1审核通过 2审核失败',
  `admin_id` int(11) DEFAULT NULL COMMENT '经纪人id',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `admin_id` (`admin_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户需求表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户需求图集表';
...
CREATE TABLE `tp_user_reserve` (
  ...
  KEY `house_id` (`house_id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='用户预约表';
